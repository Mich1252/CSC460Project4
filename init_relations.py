...
def fillTransactionTable():
    ...
    retval.append("insert into Transaction values (4, 2, 1001, TO_DATE('11/30/2023', 'MM/DD/YYYY'), 'Purchase', 'Y')")
    ...
    retval.append("insert into Transaction values (17, 0, 450, TO_DATE('11/28/2023', 'MM/DD/YYYY'), 'Purchase', 'Y')")
    retval.append("insert into Transaction values (18, 3, 550, TO_DATE('11/28/2023', 'MM/DD/YYYY'), 'Purchase', 'Y')")
    retval.append("insert into Transaction values (19, 4, 550, TO_DATE('11/28/2023', 'MM/DD/YYYY'), 'Purchase', 'Y')")
    retval.append("insert into Transaction values (20, 5, 550, TO_DATE('11/28/2023', 'MM/DD/YYYY'), 'Purchase', 'Y')")
    retval.append("commit")
    return retval
...
def fillEquipmentTable():
    ...
    retval.append("insert into Equipment values (0, 'Basketball', 27, 31)")
    retval.append("insert into Equipment values (1, 'Tennis Racket', 20, 20)")
    retval.append("insert into Equipment values (2, 'Soccer Ball', 20, 30)")
    ...
    retval.append("insert into Equipment values (10, 'Baseball Bats', 17, 18)")
    retval.append("commit")
    return retval
...
def fillBorrowedTable():
    ...
    retval.append("insert into Borrowed values (0, 0, 1, TO_DATE('11/29/2023 11:12', 'MM/DD/YYYY HH:MI'), NULL, 'N')")
    retval.append("insert into Borrowed values (0, 2, 10, TO_DATE('11/29/2023 11:12', 'MM/DD/YYYY HH:MI'), NULL, 'N')")
    retval.append("insert into Borrowed values (0, 0, 3, TO_DATE('11/29/2023 11:30', 'MM/DD/YYYY HH:MI'), NULL, 'N')")
    retval.append("insert into Borrowed values (1, 8, 1, TO_DATE('11/29/2023 11:12', 'MM/DD/YYYY HH:MI'), TO_DATE('11/29/2023 11:57', 'MM/DD/YYYY HH:MI'), 'N')")
    retval.append("insert into Borrowed values (2, 9, 1, TO_DATE('11/29/2023 11:12', 'MM/DD/YYYY HH:MI'), TO_DATE('11/29/2023 11:58', 'MM/DD/YYYY HH:MI'), 'N')")
    retval.append("insert into Borrowed values (3, 10, 1, TO_DATE('11/29/2023 11:12', 'MM/DD/YYYY HH:MI'), NULL, 'N')")
    retval.append("commit")
    return retval
...
def fillMemberTable():
    ...
    retval.append("insert into Member values (0, 'JhihYang', '000-000-0000', 1234.5, 1, 714.25)")
    retval.append("insert into Member values (1, 'John Doe', '111-222-3333', 1500.75, 0, 50.25)")
    retval.append("insert into Member values (2, 'Jane Smith', '555-666-7777', 2000.0, 2, 1031.75)")
    retval.append("insert into Member values (3, 'Bob Johnson', '999-888-7777', 800.25, 1, 655)")
    retval.append("insert into Member values (4, 'Alice Brown', '444-333-2222', 300.5, 1, 575)")
    retval.append("insert into Member values (5, 'Charlie Wilson', '777-888-9999', 1200.0, 1, 595.75)")
...
def fillCourseTable():
    ...
    retval.append("insert into Course values (1, 'Strength 101', 0, 1400, TO_DATE('08/23/2023', 'MM/DD/YYYY'), TO_DATE('12/02/2023', 'MM/DD/YYYY'), 60, 50, 3, 'MW')")
    retval.append("insert into Course values (2, 'Strength 102', 0, 1500, TO_DATE('08/23/2023', 'MM/DD/YYYY'), TO_DATE('12/02/2023', 'MM/DD/YYYY'), 60, 50, 3, 'WF')")
    ...
    retval.append("insert into Course values (4, 'Yoga 102', 1, 1500, TO_DATE('08/23/2023', 'MM/DD/YYYY'), TO_DATE('12/02/2023', 'MM/DD/YYYY'), 60, 2, 1, 'MW')")
    retval.append("commit")
    return retval
